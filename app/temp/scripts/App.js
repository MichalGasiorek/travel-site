...
var revealFeatures = new _RevealOnScroll2.default(features, "85%");

var testimonials = document.querySelectorAll('.testimonial');
var revealTestimonials = new _RevealOnScroll2.default(testimonials, "65%");
...
var RevealOnScroll = function () {
    ...
    _createClass(RevealOnScroll, [{
        ...
        value: function hideInit() {
            this.itemToReveal.forEach(function (item) {
...
var StickyHeader = function () {
    ...
    _createClass(StickyHeader, [{
        ...
        value: function createPageSectionWaypoints() {
            ...
            this.pageSections.forEach(function (item) {
                var that = _this;
                new Waypoint({
                    element: item,
                    handler: function handler(direction) {
                        ...
                        if (direction === 'down') {
                            ...
                            that.headerLinks.forEach(function (link) {
